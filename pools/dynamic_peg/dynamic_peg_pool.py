...
class DynmaicPeg():  # pylint: disable=too-many-instance-attributes
    ...
    def _tweak_price(  # noqa: complexity: 12
        ...
        if last_prices_timestamp < block_timestamp:
            ...
            if n_coins == 2:
                ...
                raise ValueError("More than 3 coins is not supported.")
        ...
        if p_i is None:
            ...
            raise KeyError(f"p_i (last price) cannot be {p_i}.")
    ...
    def lp_price(self) -> int:
        ...
        if self.n == 2:
            ...
            raise KeyError("LP price calc doesn't support more than 3 coins")
